...
class YachtsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create yacht" do
    assert_difference('Yacht.count') do
      post yachts_url, params: { yacht: { description: @yacht.description, model: @yacht.model, price: @yacht.price, rating: @yacht.rating } }
    end
  ...
  test "should update yacht" do
    patch yacht_url(@yacht), params: { yacht: { description: @yacht.description, model: @yacht.model, price: @yacht.price, rating: @yacht.rating } }
